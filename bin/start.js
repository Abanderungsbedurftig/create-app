...
exec(
  ...
  (initErr, initStdout, initStderr) => {
    ...
    const filesToCopy = ["webpack.config.cmn.js", "webpack.config.dev.js", "webpack.config.prod.js"];
    ...
    exec(
      `cd ${process.argv[2]} && git init && node -v && npm -v && yarn add -D ${devDeps} && yarn add ${deps}`,
